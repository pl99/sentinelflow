...
public class InsightConsumer {
    ...
    public void consume(LlmInsight insight) {
        log.info("Processing insight for anomaly {}", insight.anomalyId());
        ...
        var alert = alertService.createAlert(title, "WARNING", service, description, recommendation, insight.anomalyId());
