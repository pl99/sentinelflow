...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, AnomalyEvent> anomalyConsumerFactory() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, AnomalyEvent.class.getName());
    ...
    public ConcurrentKafkaListenerContainerFactory<String, AnomalyEvent> kafkaListenerContainerFactory(
        ...
        var factory = new ConcurrentKafkaListenerContainerFactory<String, AnomalyEvent>();
        factory.setConsumerFactory(consumerFactory);
        return factory;
    }

    @Bean
    public ProducerFactory<String, LlmInsight> insightProducerFactory() {
        var props = new HashMap<String, Object>();
    ...
    @Bean
    public KafkaTemplate<String, LlmInsight> kafkaTemplate(
            ProducerFactory<String, LlmInsight> producerFactory) {
